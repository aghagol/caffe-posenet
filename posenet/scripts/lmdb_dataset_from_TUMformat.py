...
directory = '/home/mo/Desktop/ROS_data/jaguar/2016-07-21/'
# directory = '/home/mo/Desktop/ROS_data/jaguar/2016-07-22/'
# directory = '/home/mo/Desktop/ROS_data/pioneer/2016-04-27/'
with open(directory+('dataset_%s_nn.txt'%dataset)) as f:
    for idx, line in enumerate(f):
        ...
        images.append('%s/%s/left/%s.png'%(directory,dataset,fname))
...
directory = '/home/mo/Desktop/ROS_data/jaguar/multiday/'
print 'Creating PoseNet Dataset.'
env = lmdb.open(directory+dataset+'_lmdb_224', map_size=int(1e12))
